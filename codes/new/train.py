...
if __name__ == '__main__':
    ...
    python train.py --save_dir /data/cristian/projects/med_data/rise-miccai/task-1/2d_models/results/lisa_clean_label_tokens_testback2_z_newaug2_pos+bbox+giou+newmodel_brain.0.1 --experiment_name lisa_clean_label_tokens_testback2_z_newaug2_pos+bbox+giou+newmodel_brain.0.1 --norm_mode dataset_z_per_view --device cuda:2 --slice_frac 0.99 --dynamic_w 0.25,0.5,1.0 --epochs 5000 --patience 100 --image_size 256 --batch_size 32 --lr 1e-5 --base_model maxvit_nano_rw_256.sw_in1k --head_type label_tokens --use_view --aggregators mean vote max weighted --volume_id patient_id --n_splits 5 --top_k 2 --threshold_brain_presence 0.1 --lambda_aux 0.2 --do_inference

    python train.py --save_dir /data/cristian/projects/med_data/rise-miccai/task-1/2d_models/results/new_model_bbox_giou_brain0.1_l0.1 --experiment_name new_model_bbox_giou_brain0.1_l0.1 --norm_mode dataset_z_per_view --device cuda:0 --slice_frac 0.99 --dynamic_w 0.25,0.5,1.0 --epochs 5000 --patience 200 --image_size 256 --batch_size 32 --lr 1e-5 --base_model maxvit_nano_rw_256.sw_in1k --head_type label_tokens --use_view --aggregators mean vote max weighted --volume_id patient_id --n_splits 5 --top_k 2 --threshold_brain_presence 0.1 --lambda_aux 0.1 --do_inference

    python train.py --save_dir /data/cristian/projects/med_data/rise-miccai/task-1/2d_models/results/new_model_bbox_giou_brain0.1_l0.2 --experiment_name new_model_bbox_giou_brain0.1_l0.2 --norm_mode dataset_z_per_view --device cuda:1 --slice_frac 0.99 --dynamic_w 0.25,0.5,1.0 --epochs 5000 --patience 200 --image_size 256 --batch_size 32 --lr 1e-5 --base_model maxvit_nano_rw_256.sw_in1k --head_type label_tokens --use_view --aggregators mean vote max weighted --volume_id patient_id --n_splits 5 --top_k 2 --threshold_brain_presence 0.1 --lambda_aux 0.2 --do_inference 

    python train.py --save_dir /data/cristian/projects/med_data/rise-miccai/task-1/2d_models/results/new_model_bbox_giou_brain0.1_l0.3 --experiment_name new_model_bbox_giou_brain0.1_l0.3 --norm_mode dataset_z_per_view --device cuda:2 --slice_frac 0.99 --dynamic_w 0.25,0.5,1.0 --epochs 5000 --patience 200 --image_size 256 --batch_size 32 --lr 1e-5 --base_model maxvit_nano_rw_256.sw_in1k --head_type label_tokens --use_view --aggregators mean vote max weighted --volume_id patient_id --n_splits 5 --top_k 2 --threshold_brain_presence 0.1 --lambda_aux 0.3 --do_inference    

    python train.py --save_dir /data/cristian/projects/med_data/rise-miccai/task-1/2d_models/results/new_model_bbox_giou_brain0.1_l0.4 --experiment_name new_model_bbox_giou_brain0.1_l0.4 --norm_mode dataset_z_per_view --device cuda:3 --slice_frac 0.99 --dynamic_w 0.25,0.5,1.0 --epochs 5000 --patience 200 --image_size 256 --batch_size 32 --lr 1e-5 --base_model maxvit_nano_rw_256.sw_in1k --head_type label_tokens --use_view --aggregators mean vote max weighted --volume_id patient_id --n_splits 5 --top_k 2 --threshold_brain_presence 0.1 --lambda_aux 0.4 --do_inference 

    python train.py --save_dir /data/cristian/projects/med_data/rise-miccai/task-1/2d_models/results/new_model_bbox_giou_brain0.1_l0.5 --experiment_name new_model_bbox_giou_brain0.1_l0.5 --norm_mode dataset_z_per_view --device cuda:4 --slice_frac 0.99 --dynamic_w 0.25,0.5,1.0 --epochs 5000 --patience 200 --image_size 256 --batch_size 32 --lr 1e-5 --base_model maxvit_nano_rw_256.sw_in1k --head_type label_tokens --use_view --aggregators mean vote max weighted --volume_id patient_id --n_splits 5 --top_k 2 --threshold_brain_presence 0.1 --lambda_aux 0.5 --do_inference 

    python train.py --save_dir /data/cristian/projects/med_data/rise-miccai/task-1/2d_models/results/new_model_bbox_giou_brain0.1_l0.125 --experiment_name new_model_bbox_giou_brain0.1_l0.125 --norm_mode dataset_z_per_view --device cuda:5 --slice_frac 0.99 --dynamic_w 0.25,0.5,1.0 --epochs 5000 --patience 200 --image_size 256 --batch_size 32 --lr 1e-5 --base_model maxvit_nano_rw_256.sw_in1k --head_type label_tokens --use_view --aggregators mean vote max weighted --volume_id patient_id --n_splits 5 --top_k 2 --threshold_brain_presence 0.1 --lambda_aux 0.125 --do_inference 
    """